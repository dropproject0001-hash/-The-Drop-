...
export default function DropMap({ drops = [], height = '600px' }: DropMapProps) {
  ...
  return (
    <ErrorBoundary fallback={<div style={{ height }} className="w-full bg-zinc-900 flex items-center justify-center text-red-500 font-mono">MAP_RENDER_ERROR</div>}>
      <div style={{ height }} className="relative w-full rounded-2xl overflow-hidden border border-zinc-800">
        <MapContainer
