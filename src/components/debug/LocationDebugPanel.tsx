...
export function LocationDebugPanel({ visible = true }: DebugPanelProps) {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[9999] w-80 bg-zinc-950 border border-[#106011] rounded-2xl shadow-[0_0_30px_rgba(16,96,17,0.3)] text-white font-mono text-xs overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between bg-[#106011]/10 px-4 py-2 border-b border-[#106011]/30">
        <div className="flex items-center gap-2">
          <div className={`w-2 h-2 rounded-full ${isOnline ? 'bg-emerald-500' : 'bg-red-500'} animate-pulse`} />
          <span className="font-bold tracking-widest text-[#0ad111]">LOCATION DEBUG</span>
        </div>
        <button 
